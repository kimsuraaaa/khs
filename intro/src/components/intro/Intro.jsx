...
export default function Intro () {
    ...
    const scrollAction = () =>{
        let positionIndex = window.pageYOffset,
            sectionPoint = document.querySelectorAll('.motion-position');

        for(let i=0; i < sectionPoint.length > 0; i++){
            if((0 >= (sectionPoint[i].getBoundingClientRect().top)) && (sectionPoint[i].getBoundingClientRect().top) > (sectionPoint[i].offsetHeight * -1)){
                sectionPoint[i].classList.add('motion-start');
            } else {
                sectionPoint[i].classList.remove('motion-start');
            }
        }
    }
                            ...
                            <ul>
                                ...
                                <li>
                                    <dl>
                                        ...
                                        <dd>SPA 개발 방식으로 <em>React</em> 경험이 있습니다. 해당 포트폴리오 페이지 또한 React로 개발되었습니다.</dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                ...
                <li className="about">
                    <div className="inner">
                        ...
                        <div className="profile-box">
                            ...
                            <p>김현수 (KIMHYUNSU)<br/>Tel : <a href="sms:01049221429">01049221429</a><br/>mail : <a href="mailto:primenumber43@naver.com">primenumber43@naver.com</a></p>
                        </div>
                    </div>
                </li>
            </ul>
