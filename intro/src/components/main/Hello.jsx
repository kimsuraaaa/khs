        ...
        <>
            <section className="main-section hello-col">
                <div className="inner">
                    ...
                    <p>이 사이트는 개인 소개 목적으로 만들어진 사이트로,<br />React로 개발되었으며, <em>Interaction motion</em> 요소들은 라이브러리 사용을 피해<br /><strong>Javascript</strong> 와 <strong>CSS Keyframe animation</strong>을 사용하여 구현했습니다.</p>
                </div>
            </section>
        </>
    )
